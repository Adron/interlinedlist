...
Welcome to InterlinedList! This guide will help you get oriented with the platform.

## Home vs Dashboard

**Home** (click the home icon) shows the main feed: your messages plus all public messages from others. The left sidebar includes the message input and your lists tree. Use this to browse and post to the broader community.

**Dashboard** (click the chart icon) shows only your own messages in a table view. It also includes Data Management (links to Exports and Settings) and your profile summary. Use this to manage your content and access exports.

## Navigation

Use the top bar to move around:
...
- **Documents** — Markdown notes and folders; create and edit in the browser
